...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingTop: 20, paddingBottom: 15, borderBottomWidth: 1, borderBottomColor: '#e2e8f0', gap: 8 },
  backBtn: { padding: 8 },
  closeIcon: { fontSize: 24, color: '#4a5568' },
