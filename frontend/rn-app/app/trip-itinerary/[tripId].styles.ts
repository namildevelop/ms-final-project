...
export const styles = StyleSheet.create({
  ...
  tabContainer: { flexDirection: 'row', backgroundColor: '#FFFFFF', paddingHorizontal: 15 },
  tabHalf: { flex: 1, alignItems: 'center' },
  tab: { paddingVertical: 10, paddingHorizontal: 64, borderRadius: 22, backgroundColor: 'transparent' },
  ...
  controlBar: { paddingVertical: 10, paddingHorizontal: 15, backgroundColor: '#FFFFFF', borderBottomWidth: 1, borderBottomColor: '#E5E7EB', flexDirection: 'row', alignItems: 'center' },
